...
class Scheduler(SchedulerInterface):
    def __init__(
        ...
        self.max_num_async_loaded_tokens = 4 * 16384
        ...
        self.num_tokens_being_async_loaded = 0
            ...
            while self.waiting and token_budget > 0:
                ...
                if request.status == RequestStatus.WAITING_FOR_REMOTE_KVS:
                    ...
                    if is_ready:
                        ...
                        self.num_tokens_being_async_loaded -= request.num_external_computed_tokens
                        assert self.num_requests_being_async_loaded >= 0
                        assert self.num_tokens_being_async_loaded >= 0
                    else:
                        logger.debug(
                ...
                if load_kv_async:
                    ...
                    self.num_requests_being_async_loaded += 1
                    self.num_tokens_being_async_loaded += request.num_external_computed_tokens
                    if self.num_tokens_being_async_loaded > self.max_num_async_loaded_tokens:
                        break
                    continue
