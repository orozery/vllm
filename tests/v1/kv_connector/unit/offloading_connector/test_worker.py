...
def test_register_kv_caches(mock_get_layers, backend):
    ...
    Uses the real GPUModelRunner._allocate_kv_cache_tensors and
    _reshape_kv_cache_tensors to produce kv_caches, which automatically
    applies _update_hybrid_attention_mamba_layout for hybrid models.
